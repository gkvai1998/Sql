...
"""
thanks for choice direct action bangladesh
"""
...
try:
    ...
    try:
        ...
        sys.exit("[!] wrong installation detected (missing modules). Visit 'https://github.com/gkvai1998/sqlmap-dab/#installation' for further details")
